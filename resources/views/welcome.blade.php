<x-app-layout>
    <div class="relative overflow-hidden pt-12 pb-20 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white min-h-screen transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto space-y-6">
                ...
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/30 text-indigo-600 dark:text-indigo-300 text-xs font-mono font-semibold uppercase tracking-wider">
                ...
                <h1 class="text-4xl sm:text-6xl font-black tracking-tight leading-tight text-slate-900 dark:text-white">
                    La transparence et le suivi clair de vos <span class="bg-gradient-to-r from-indigo-600 to-emerald-600 dark:from-indigo-400 dark:to-emerald-400 bg-clip-text text-transparent">Projets Partagés</span>.
                </h1>

                <p class="text-slate-600 dark:text-slate-400 text-sm sm:text-base leading-relaxed font-normal max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                <div class="p-6 rounded-3xl bg-white/70 dark:bg-white/[0.045] border border-slate-200/80 dark:border-white/10 shadow-sm dark:shadow-none backdrop-blur-xl dark:backdrop-blur-2xl">
            ...
            <div class="mt-20">
                <div class="text-center mb-10">
                    <h2 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">Conçu pour être simple et efficace</h2>
                    <p class="text-slate-500 dark:text-slate-400 text-xs mt-1">Les points forts de la plateforme.</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="p-6 rounded-3xl bg-white/60 dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/10 space-y-3">
                        ...
                        <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">Regroupement clair de tous les besoins et aides financières en un seul endroit.</p>
                    </div>
                    ...
                    <div class="p-6 rounded-3xl bg-white/60 dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/10 space-y-3">
                        ...
                        <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">Chaque action est enregistrée instantanément pour que tout soit parfaitement à jour.</p>
                    </div>

                    <div class="p-6 rounded-3xl bg-white/60 dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/10 space-y-3">
                        <div class="w-10 h-10 rounded-xl bg-fuchsia-50 dark:bg-fuchsia-500/10 border border-fuchsia-200 dark:border-fuchsia-500/20 flex items-center justify-center text-fuchsia-600 dark:text-fuchsia-400">
                        ...
                        <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">Un journal d'activités clair pour vérifier facilement toutes les opérations réalisées.</p>
                    </div>
                </div>
            </div>
