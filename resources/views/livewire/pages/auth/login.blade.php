    ...
    <div class="relative w-full max-w-md p-8 sm:p-10 rounded-3xl bg-white/70 dark:bg-slate-900/60 backdrop-blur-2xl border border-white/40 dark:border-slate-800/80 shadow-2xl shadow-indigo-500/10">
        ...
        <form wire:submit="login" class="space-y-6">
            ...
            <div>
                ...
                <x-ui.password-input id="password" wireModel="form.password" autocomplete="current-password" />
            ...
            <div class="flex items-center justify-between">
                <label for="remember" class="inline-flex items-center cursor-pointer">
                    <input
                        ...
                        id="remember"
                        type="checkbox"
                        class="rounded border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950 text-indigo-600 shadow-sm focus:ring-indigo-500 checked:bg-indigo-600"
                    >
